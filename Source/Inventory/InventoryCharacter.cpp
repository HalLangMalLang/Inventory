...
{
	Super::BeginPlay();
	//InventoryComponent->LoadInventory(GetWorld()->GetFirstPlayerController());
}

void AInventoryCharacter::NotifyControllerChanged()
{
...
void AInventoryCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(InventoryAction, ETriggerEvent::Started, this, &AInventoryCharacter::InventoryToggle);
	}
	else
	{
...
void AInventoryCharacter::InventoryToggle(const FInputActionValue& Value)
{
	UE_LOG(LogTemp, Log, TEXT("InventoryToggle"));
	InventoryComponent->InventoryToggle(GetWorld()->GetFirstPlayerController(), bIsActiveInventory);
	bIsActiveInventory = !bIsActiveInventory;
}
